...
using Cinemachine; // Thêm dòng này để sử dụng Cinemachine
...
public class NPC : MonoBehaviour
{
    ...
    private PlayerTest playerScript; // Biến lưu trữ script điều khiển di chuyển của người chơi
    ...
    void Start()
    {
        ...
        playerScript = FindObjectOfType<PlayerTest>();
